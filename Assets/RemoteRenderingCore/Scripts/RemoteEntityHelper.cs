...
public class RemoteEntityHelper : BaseRemoteEntityHelper
{
    ...
    public void ManipulateObj(Entity entity)
    {
/*        var entityGameObject = entity.GetOrCreateGameObject(UnityCreationMode.DoNotCreateUnityComponents);
        objectManipulator = entityGameObject.AddComponent<ObjectManipulator>();
        var obj = entityGameObject.AddComponent<ObjectManipulatorEventsRedirect>();
        entityGameObject.AddComponent<BoxCollider>();
        obj.redirectTarget = objectManipulator;*/
    }
