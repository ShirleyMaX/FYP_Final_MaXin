...
{
    private static string ACCESS_KEY = "yqyO+cS+mxtrHdhLaC+KPPuGVUegikxQRwVcSuMCEombMb2wTT/kFQ=="; // AccessKey obtained from Picovoice Console (https://console.picovoice.ai/)
